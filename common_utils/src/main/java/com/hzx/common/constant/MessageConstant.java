...
public class MessageConstant {
    ...
    public static final String MESSAGE_ERROR = "验证码错误";
    ...
    public static final String USER_NO_ORDERS = "用户无点餐历史记录";
    ...
    public static final String ORDER_TIMEOUT_AUTOCANCEL_REASON = "订单超时，自动取消";
